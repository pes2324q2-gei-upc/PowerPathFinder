...
class User(baseUser):
    ...
    updated_at = models.DateTimeField("Last modification of the User", auto_now=True, auto_now_add=False)
    created_at = models.DateTimeField("Creation date of the User", auto_now=False, auto_now_add=True)
...
class Valuation(models.Model):
    ...
    receiver_user = models.ForeignKey(
        User, related_name="received_user_valuations", on_delete=models.CASCADE, null=True, blank=True
    )
