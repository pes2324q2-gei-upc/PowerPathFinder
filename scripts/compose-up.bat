...
.venv\Scripts\python ppf-route-api\manage.py loaddata sample_common_driver.json sample_common_user.json sample_user_auth.json sample_common_routes.json
